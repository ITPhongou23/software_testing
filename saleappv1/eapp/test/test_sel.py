...
def test_search_product(driver):
    ...
    kw = 'iPhone'
    # e.send_keys(kw)
    # driver.find_element(By.CSS_SELECTOR,'#collapsibleNavbar > form > input').click()
    ...
    results = driver.find_elements(By.CSS_SELECTOR,'.container .card_title')
...
def test_register(driver):
    ...
    register.open_page()
    register.register(name='demo',username='demodemo',password='Demo@123',confirm='Demo@123',avatar='D:\Capture.PNG')
